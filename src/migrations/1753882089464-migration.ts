...
export class Migration1753882089464 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "job_application" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "appliedAt" TIMESTAMP NOT NULL DEFAULT now(), "applicantId" uuid, "jobId" uuid, CONSTRAINT "UQ_559c5792c511d5fe3468d80e5ee" UNIQUE ("jobId", "applicantId"), CONSTRAINT "PK_c0b8f6b6341802967369b5d70f5" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "job" ADD CONSTRAINT "FK_228b150b2333ecd5dbf4f7fc1fa" FOREIGN KEY ("createdById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "job" DROP CONSTRAINT "FK_228b150b2333ecd5dbf4f7fc1fa"`,
    );
    await queryRunner.query(
